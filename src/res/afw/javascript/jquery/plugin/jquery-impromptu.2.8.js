...
(function($) {
    ...
    //NOTE: CARLO
    //pour que ça fonctionne correctement avec IE6-7-8
		//var ie6		= ($.browser.msie && $.browser.version < 7);
		var ie6 = ($.browser.msie); //workaround for ie8
    var $body	= $(document.body);
		...
		msgbox += options.prefix +'close"><span class="'+options.prefix+'close_btn">X</span></div><div id="'+ options.prefix +'states"></div>';
		msgbox += '</div></div></div>';
    ...
    /*$jqi.find('.'+ options.prefix +'close').click(removePrompt);*/
		$jqi.find('.'+ options.prefix +'close_btn').click(removePrompt);
