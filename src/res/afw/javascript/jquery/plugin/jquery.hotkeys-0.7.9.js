...
(function ($){
    ...
    hotkeys.specialKeys = $.extend(hotkeys.specialKeys, { 96: '0', 97:'1', 98: '2', 99: 
    ...
    $.fn.find = function( selector ) {
        this.query = selector;
        return $.fn.__find__.apply(this, arguments);
    };
    
    $.fn.unbind = function (type, combi, fn){
        if ($.isFunction(combi)){
            fn = combi;
            combi = null;
        }
    ...
    $.fn.bind = function(type, data, fn){
        ...
        if ($.isFunction(data) || !handle){
            ...
            pass2jq = $.trim(type.replace(hotkeys.override, ''));
