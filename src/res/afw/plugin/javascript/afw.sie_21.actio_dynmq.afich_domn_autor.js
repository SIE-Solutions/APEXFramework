/**
 * @namespace afw.sie_21.actio_dynmq.afich_domn_autor
 */
afw.sie_21.actio_dynmq.afich_domn_autor = {
  insta: [],
  obten : function(pva_id_regn) {
    var vjs_insta;
    
    for (i=0; i<afw.sie_21.actio_dynmq.afich_domn_autor.insta.length; i++) {
      if (afw.sie_21.actio_dynmq.afich_domn_autor.insta[i].optio.vva_id_regn == pva_id_regn) {
        vjs_insta = afw.sie_21.actio_dynmq.afich_domn_autor.insta[i];
        break;
      }
    }
  ...
  suprm : function(pva_id_regn) {
    for (i=0; i<afw.sie_21.actio_dynmq.afich_domn_autor.insta.length; i++) {
      if (afw.sie_21.actio_dynmq.afich_domn_autor.insta[i].optio.vva_id_regn == pva_id_regn) {
        afw.sie_21.actio_dynmq.afich_domn_autor.insta.splice(i,1);
      }
    }
  },
  /**
