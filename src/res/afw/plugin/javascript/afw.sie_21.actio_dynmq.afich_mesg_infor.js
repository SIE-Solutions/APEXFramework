/**
 * @namespace afw.sie_21.actio_dynmq.afich_mesg_infor
 */
afw.sie_21.actio_dynmq.afich_mesg_infor = {
  insta : [],
  obten : function(pnu_id) {
    for ( i = 0; i < afw.sie_21.actio_dynmq.afich_mesg_infor.insta.length; i++) {
      if (afw.sie_21.actio_dynmq.afich_mesg_infor.insta[i].id == pnu_id) {
        return afw.sie_21.actio_dynmq.afich_mesg_infor.insta[i];
      }
    }
  },
  suprm : function(pnu_id) {
    for ( i = 0; i < afw.sie_21.actio_dynmq.afich_mesg_infor.insta.length; i++) {
      if (afw.sie_21.actio_dynmq.afich_mesg_infor.insta[i].id == pnu_id) {
        afw.sie_21.actio_dynmq.afich_mesg_infor.insta.splice(i, 1);
      }
    }
  },
  /**
   * @constructor
   */
  afich_mesg_infor : function(pjs_optio, pjs_calbc) {
