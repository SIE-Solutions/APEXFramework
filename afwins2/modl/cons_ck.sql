...
ALTER TABLE SIE_01_CONFG_EVENM_NOTFB ADD (
  ...
  CHECK ((ref_compt_twili is null and ref_profl_courl is not null) or (ref_compt_twili is not null and ref_profl_courl is null))
  ENABLE VALIDATE);
...
ALTER TABLE SIE_01_MESG_INFOR ADD (
  ...
  CHECK ((SESS_ID is not null and REF_UTILS is null) or (SESS_ID is null and REF_UTILS is not null))
  ENABLE VALIDATE);
...
ALTER TABLE SIE_07_AUDIT_STRUC_APLIC ADD (
  ...
  CHECK ((natr_audit in ('CRE','MOD','SUP') and ref_page is null and ref_actio_audit is null) or (natr_audit in ('CRE','MOD','SUP')))
  ENABLE VALIDATE,
  CONSTRAINT SIE_07_AUDIT_STRUC_APLIC_CK3
  CHECK ((natr_audit = 'PER' and ref_actio_audit is not null and ref_page is null) or natr_audit != 'PER')
  ENABLE VALIDATE,
  CONSTRAINT SIE_07_AUDIT_STRUC_APLIC_CK4
  CHECK ((natr_audit = 'AFF' and ref_actio_audit is null and ref_page is not null) or natr_audit != 'AFF')
  ENABLE VALIDATE);
...
ALTER TABLE SIE_12_STAT ADD (
  ...
  CHECK ((ref_group_stat is null and ref_struc_aplic is not null) or (ref_group_stat is not null and ref_struc_aplic is null))
  ENABLE VALIDATE);
...
ALTER TABLE SIE_12_STRUC_APLIC ADD (
  ...
  CHECK ((INDIC_EXTRA_TOUT = 'N' AND TAIL_TABL_EXTRA is not null) OR INDIC_EXTRA_TOUT in ('O', 'HE'))
  ENABLE VALIDATE,
...
ALTER TABLE SIE_12_UTILS ADD (
  ...
  courl is null
  or
  regexp_like (courl,'^[[:alnum:]]+((_|\.|\-|)[[:alnum:]]+)*@[[:alnum:]]+(\-|[[:alnum:]]+)*(\.[[:alnum:]]+){1,2}$')
)
  ENABLE VALIDATE);
...
ALTER TABLE SIE_13_ITEM_MENU ADD (
  ...
  CHECK ((ref_page is not null and forml_valr_url is null) or (ref_page is null and forml_valr_url is not null)
...
ALTER TABLE SIE_13_RESRC ADD (
  ...
  CHECK ((indic_stock_meme_reprt = 'O' and ref_dosr_virtl is not null) or ref_dosr_virtl is null)
  ENABLE VALIDATE,
...
ALTER TABLE SIE_14_DOMN_VALR ADD (
  ...
  CHECK ((   indic_systm = 'O')  or (   indic_systm = 'N'     and ref_type_domn_valr is not null))
  ENABLE VALIDATE,
...
ALTER TABLE SIE_19_FONCT ADD (
  ...
  CHECK ((REF_DV_TYPE_ATRIB1 is not null and VALR_DEFT_ATRIB1 is not null and TITRE_ATRIB1 is not null) or
  (REF_DV_TYPE_ATRIB1 is null and VALR_DEFT_ATRIB1 is null and TITRE_ATRIB1 is null))
  ENABLE VALIDATE,
  CONSTRAINT SIE_19_FONCT_CK2
  CHECK ((REF_DV_TYPE_ATRIB2 is not null and VALR_DEFT_ATRIB2 is not null and TITRE_ATRIB2 is not null) or
  (REF_DV_TYPE_ATRIB2 is null and VALR_DEFT_ATRIB2 is null and TITRE_ATRIB2 is null))
  ENABLE VALIDATE,
  CONSTRAINT SIE_19_FONCT_CK3
  CHECK ((REF_DV_TYPE_ATRIB3 is not null and VALR_DEFT_ATRIB3 is not null and TITRE_ATRIB3 is not null) or
  (REF_DV_TYPE_ATRIB3 is null and VALR_DEFT_ATRIB3 is null and TITRE_ATRIB3 is null))
  ENABLE VALIDATE,
  CONSTRAINT SIE_19_FONCT_CK4
  CHECK ((REF_DV_TYPE_ATRIB4 is not null and VALR_DEFT_ATRIB4 is not null and TITRE_ATRIB4 is not null) or
  (REF_DV_TYPE_ATRIB4 is null and VALR_DEFT_ATRIB4 is null and TITRE_ATRIB4 is null))
  ENABLE VALIDATE,
  CONSTRAINT SIE_19_FONCT_CK5
  CHECK ((REF_DV_TYPE_ATRIB5 is not null and VALR_DEFT_ATRIB5 is not null and TITRE_ATRIB5 is not null) or
  (REF_DV_TYPE_ATRIB5 is null and VALR_DEFT_ATRIB5 is null and TITRE_ATRIB5 is null))
  ENABLE VALIDATE);
...
ALTER TABLE SIE_19_SPECF_FONCT ADD (
  ...
  CHECK ((ref_item is not null and ref_page is null) or (ref_item is null and ref_page is not null))
  ENABLE VALIDATE);
...
ALTER TABLE SIE_21_PLUGN_ARBRE_NOEUD ADD (
  ...
  CHECK ((ref_ocurn_resrc is not null and ref_resrc is null) or (ref_ocurn_resrc is null and ref_resrc is not null))
  DISABLE NOVALIDATE);
