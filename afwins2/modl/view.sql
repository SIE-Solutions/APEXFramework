SET DEFINE OFF;
/* Formatted on 04/12/2013 11:28:08 PM (QP5 v5.185.11230.41888) */
prompt View SIE_29_AQ_APEX_APLIC_SHORT_DCM;

create or replace force view sie_29_aq_apex_aplic_short_dcm
(
  id,
  flow_id,
  shortcut_name
...
/* Formatted on 04/12/2013 11:28:08 PM (QP5 v5.185.11230.41888) */
prompt View SIE_29_AQ_APEX_ITEM_HIDN;

create or replace force view sie_29_aq_apex_item_hidn
(
  id,
  flow_id,
  name
...
/* Formatted on 04/12/2013 11:28:08 PM (QP5 v5.185.11230.41888) */
prompt View SIE_29_AQ_PLUGN_SANS_MESG_NDF;

create or replace force view sie_29_aq_plugn_sans_mesg_ndf
(
  id,
  flow_id,
  page_id,
...
/* Formatted on 04/12/2013 11:28:09 PM (QP5 v5.185.11230.41888) */
...
/* Formatted on 04/12/2013 11:28:09 PM (QP5 v5.185.11230.41888) */
prompt View VD_I_SIE_12_DOMN_SERVR_LDAP;

create or replace force view vd_i_sie_12_domn_servr_ldap
(
  seqnc,
  ref_domn,
  ref_servr_ldap,
...
/* Formatted on 04/12/2013 11:28:10 PM (QP5 v5.185.11230.41888) */
...
/* Formatted on 04/12/2013 11:28:10 PM (QP5 v5.185.11230.41888) */
prompt View VD_I_SIE_12_SERVR_LDAP;

create or replace force view vd_i_sie_12_servr_ldap
(
  seqnc,
  adres,
  port,
...
/* Formatted on 04/12/2013 11:28:11 PM (QP5 v5.185.11230.41888) */
...
/* Formatted on 04/12/2013 11:28:12 PM (QP5 v5.185.11230.41888) */
...
/* Formatted on 04/12/2013 11:28:13 PM (QP5 v5.185.11230.41888) */
...
/* Formatted on 04/12/2013 11:28:13 PM (QP5 v5.185.11230.41888) */
prompt View VD_SIE_12_DOMN_SERVR_LDAP;

create or replace force view vd_sie_12_domn_servr_ldap
(
  seqnc,
  ref_domn,
  ref_servr_ldap,
  ...
  select   "SEQNC",
           ...
           "DATE_MODFC",
           "UTILS_MODFC"
    from   vd_i_sie_12_domn_servr_ldap;
...
/* Formatted on 04/12/2013 11:28:14 PM (QP5 v5.185.11230.41888) */
...
/* Formatted on 04/12/2013 11:28:14 PM (QP5 v5.185.11230.41888) */
prompt View VD_SIE_12_SERVR_LDAP;

create or replace force view vd_sie_12_servr_ldap
(
  seqnc,
  adres,
  port,
...
/* Formatted on 04/12/2013 11:28:15 PM (QP5 v5.185.11230.41888) */
...
/* Formatted on 04/12/2013 11:28:16 PM (QP5 v5.185.11230.41888) */
...
/* Formatted on 04/12/2013 11:28:17 PM (QP5 v5.185.11230.41888) */
...
/* Formatted on 04/12/2013 11:28:17 PM (QP5 v5.185.11230.41888) */
prompt View VS_STAT_COMNC_ENTRA;
...
/* Formatted on 04/12/2013 11:28:17 PM (QP5 v5.185.11230.41888) */
prompt View VS_STAT_REQT_CORCT;
...
/* Formatted on 04/12/2013 11:28:17 PM (QP5 v5.185.11230.41888) */
prompt View VS_STAT_SUCRS;

create or replace force view vs_stat_sucrs
(
  d,
  r
) as
  select   nom d,
           seqnc r
    from   vd_sie_12_stat s
   where   s.ref_struc_aplic_formt = 'SUCRS';
...
/* Formatted on 04/12/2013 11:28:17 PM (QP5 v5.185.11230.41888) */
prompt View SIE_29_AQ_IR_MESG_TROP_DON;

create or replace force view sie_29_aq_ir_mesg_trop_don
(
  id,
  flow_id,
  page_id,
...
/* Formatted on 04/12/2013 11:28:17 PM (QP5 v5.185.11230.41888) */
prompt View SIE_29_AQ_IR_NO_DATA_FOUND;

create or replace force view sie_29_aq_ir_no_data_found
(
  id,
  flow_id,
  page_id,
...
/* Formatted on 04/12/2013 11:28:17 PM (QP5 v5.185.11230.41888) */
prompt View SIE_29_AQ_RAPRT_NO_DATA_FOUND;

create or replace force view sie_29_aq_raprt_no_data_found
(
  id,
  flow_id,
  page_id,
...
/* Formatted on 04/12/2013 11:28:18 PM (QP5 v5.185.11230.41888) */
...
/* Formatted on 04/12/2013 11:28:18 PM (QP5 v5.185.11230.41888) */
prompt View VS_PARMT_RAPRT_FEUIL_TEMPS;

create or replace force view vs_parmt_raprt_feuil_temps
(
  seqnc,
  sucrs
) as
  select   valr_numbr1 seqnc,
           valr_numbr2 sucrs
    from   vs_sie_25_par_pub_tra_exect;


/* Formatted on 04/12/2013 11:28:18 PM (QP5 v5.185.11230.41888) */
prompt View VS_PARMT_RAPRT_PROJT;

create or replace force view vs_parmt_raprt_projt
(
  ref_etat,
  ref_prest,
  date_etat,
...
/* Formatted on 04/12/2013 11:28:18 PM (QP5 v5.185.11230.41888) */
prompt View VS_PARMT_RAPRT_TELCP;

create or replace force view vs_parmt_raprt_telcp (seqnc) as
  select   valr_numbr1 seqnc
    from   vs_sie_25_par_pub_tra_exect;


/* Formatted on 04/12/2013 11:28:19 PM (QP5 v5.185.11230.41888) */
prompt View VS_PRODT_AUTHO_SDP;

create or replace force view vs_prodt_autho_sdp
(
  seqnc,
  code,
  nom,
...
/* Formatted on 04/12/2013 11:28:19 PM (QP5 v5.185.11230.41888) */
prompt View VS_TYPE_CATGR;

create or replace force view vs_type_catgr
(
  seqnc,
  code_valr,
  valr
  ...
  select   ddv.seqnc,
   ...
   where   dv.seqnc = ddv.ref_domn_valr and dv.code = 'TYPE_CATGR';


/* Formatted on 04/12/2013 11:28:19 PM (QP5 v5.185.11230.41888) */
prompt View VS_TYPE_RECRS_PLANF;

create or replace force view vs_type_recrs_planf
(
  seqnc,
  code_valr,
  valr,
  ...
  select   ddv.seqnc,
    ...
    from   vd_sie_14_detl_domn_valr ddv,
           vd_sie_14_domn_valr dv
   where   dv.seqnc = ddv.ref_domn_valr and dv.code = 'TYPE_RECRN_PLANF';


/* Formatted on 04/12/2013 11:28:19 PM (QP5 v5.185.11230.41888) */
prompt View VS_TYPE_REMRQ_TELCP;

create or replace force view vs_type_remrq_telcp
(
  seqnc,
  valr,
  seqnc_presn
  ...
  select   ddv.seqnc,
    ...
    from   vd_sie_14_domn_valr dv,
           vd_sie_14_detl_domn_valr ddv
   where   ddv.ref_domn_valr = dv.seqnc and dv.code = 'TYPE_REMRQ_TELCP';
...
(
  ...
  select   seqnc,
           ...
           (select   mes.numr_mesg
              from   vd_sie_01_mesg mes
             where   mes.seqnc = pic.ref_mesg_aide)
             ref_mesg_aide_numr
    from   vd_i_sie_13_page_ir_coln pic;


Prompt Trigger VD_SIE_13_PAGE_IR_COLN_IOU_TRG;
/* Formatted on 18/12/2013 9:34:25 AM (QP5 v5.185.11230.41888) */
