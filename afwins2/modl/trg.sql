...
/* Formatted on 6/3/2013 10:11:52 PM (QP5 v5.185.11230.41888) */
...
Prompt Trigger SIE_12_COMPT_PAYPL_BIU_TRG;
/* Formatted on 6/3/2013 10:11:52 PM (QP5 v5.185.11230.41888) */
create or replace trigger sie_12_compt_paypl_biu_trg
  before insert or update
  on sie_12_compt_paypl
  for each row
begin
  if inserting and :new.seqnc is null then
    :new.seqnc := sie_12_compt_paypl_seq.nextval;
  end if;
  ...
  sie_07_util_pkg.genr_valr_audit (inserting,
                                   ...
                                   :new.utils_modfc,
                                   :new.date_modfc);
end sie_12_compt_paypl_biu_trg;
/
...
Prompt Trigger SIE_12_DETL_FORML_BIU_TRG;
/* Formatted on 6/3/2013 10:11:52 PM (QP5 v5.185.11230.41888) */
create or replace trigger sie_12_detl_forml_biu_trg
  before insert or update
  on sie_12_detl_forml
  for each row
begin
  if inserting and :new.seqnc is null then
    :new.seqnc := sie_12_forml_seq.nextval;
  end if;
...
Prompt Trigger SIE_12_FORML_BIU_TRG;
/* Formatted on 6/3/2013 10:11:52 PM (QP5 v5.185.11230.41888) */
create or replace trigger sie_12_forml_biu_trg
  before insert or update
  on sie_12_forml
  for each row
begin
...
Prompt Trigger SIE_12_PAYPL_RETR_APLI_BIU_TRG;
/* Formatted on 6/3/2013 10:11:52 PM (QP5 v5.185.11230.41888) */
create or replace trigger sie_12_paypl_retr_apli_biu_trg
  before insert or update
  on sie_12_paypl_retr_aplic
  for each row
begin
  if inserting and :new.seqnc is null then
    :new.seqnc := sie_12_paypl_retr_aplic_seq.nextval;
  end if;
  ...
  sie_07_util_pkg.genr_valr_audit (inserting,
                                   ...
                                   :new.utils_modfc,
                                   :new.date_modfc);
end sie_12_paypl_retr_apli_biu_trg;
/


Prompt Trigger SIE_12_REPNS_FORML_BIU_TRG;
/* Formatted on 6/3/2013 10:11:52 PM (QP5 v5.185.11230.41888) */
create or replace trigger sie_12_repns_forml_biu_trg
  before insert or update
  on sie_12_repns_forml
  for each row
begin
  if inserting and :new.seqnc is null then
    :new.seqnc := sie_12_forml_seq.nextval;
  ...
  sie_07_util_pkg.genr_valr_audit (inserting,
                                   ...
                                   :new.utils_modfc,
                                   :new.date_modfc);
end sie_12_repns_forml_biu_trg;
/
